...
function setup() {
  ...
  obstacle2 = new Obstacle(475,505,30,30);
  obstacle3 = new Obstacle(475,485,30,30);
  obstacle4 = new Obstacle(475,465,30,30);
  obstacle5 = new Obstacle(475,445,30,30);
  obstacle6 = new Obstacle(505,515,30,30);
  obstacle7 = new Obstacle(505,505,30,30);
  obstacle8 = new Obstacle(505,485,30,30);
  obstacle9 = new Obstacle(505,465,30,30);
  obstacle10 = new Obstacle(505,445,30,30);
